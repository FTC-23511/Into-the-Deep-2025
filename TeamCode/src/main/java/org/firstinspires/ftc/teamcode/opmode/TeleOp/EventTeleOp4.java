...
@TeleOp(name = "EventTeleOp4")
public class EventTeleOp4 extends CommandOpMode {
    ...
    public void run() {
        ...
        FlightRecorder.INSTANCE.addData("opModeType", opModeType.name());
        ...
        FlightRecorder.INSTANCE.addData("intakeMotorState", Intake.intakeMotorState);

        FlightRecorder.INSTANCE.addData("liftTop.getPower()", robot.liftTop.getPower());
        FlightRecorder.INSTANCE.addData("liftBottom.getPower()", robot.liftBottom.getPower());
        ...
        FlightRecorder.INSTANCE.addData("botHeading", botHeading);
        FlightRecorder.INSTANCE.addData("speedMultiplier", speedMultiplier);

        FlightRecorder.INSTANCE.update(); // DO NOT REMOVE! Needed for telemetry
        timer.reset();
